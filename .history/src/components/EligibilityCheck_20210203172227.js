...
const FormSizeDemo = ({nextStep, handleInputChange, onChangeDate, handleGenderChange, handleEmploymentChange, handleIncomeChange,handleBvnChange, handlePhoneChange,values, validateWidget}) => {
  ...
  const next = () => {
    if(validateWidget(values)) {
        nextStep()
      
    }
    nextStep
    message.error("You must fill all the inputs fields");
  }
 

  validateWidget(values)
