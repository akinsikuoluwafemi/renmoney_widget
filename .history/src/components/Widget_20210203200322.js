...
export default function Widget() {
  ...
  const pageOneState = {firstName, lastName, middleName, email, stateOfOrigin, lga, income, bvn, dob,phone, gender, employmentStatus}
    

  // const validateWidget =(obj) => {
  //   return Object.keys(obj).map((key)=> {
  //     if(obj[key].length < 1 || typeof(obj[key].length === undefined) {
