...
import { onBoardingAction,showModal } from '../actions/onBoardingAction'




function Widget({ onBoardingAction, onBoarding }) {
...
export default connect(mapStateToProps, { onBoardingAction })(Widget);