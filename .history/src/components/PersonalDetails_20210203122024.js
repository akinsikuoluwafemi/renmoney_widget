    ...
    <>
      ...
      >
        ...
        <Form.Item label="Residential Address">
          <Input type="text"  name="residentialAddress" defaultValue={values.residentialAddress} placeholder="7 tomori avenue mbambadiwe" onChange={handleResidentialAddress}  />
        </Form.Item>

        <Form.Item label="Marital Status">
          <Select defaultValue={values.maritalStatus} onChange={handleMaritalStatus}>
        ...
        <Form.Item label="Date Moved In">
          <DatePicker defaultValue={values.dateMovedIn} onChange={onChangeDateMovedIn} />
        </Form.Item>
      </Form>
    </>
  );
