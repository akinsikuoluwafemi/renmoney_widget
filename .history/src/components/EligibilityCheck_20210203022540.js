  ...
  return (
    <>
      ...
      >
        ...
        <Form.Item label="Lga">
          <Input type="text" value={state.lga} name="lga" placeholder="yaba" onChange={handleInputChange} />
        </Form.Item>
        <Form.Item label="Gender">
          <Select onChange={handleSelectCh}>
        ...
        <Form.Item label="Monthly Income">
          <InputNumber type="number" value={income} name="income" placeholder="300000" onChange={handleSelectChange} />
        </Form.Item>
        <Form.Item label="Bvn">
          <InputNumber type="number" value={state.bvn} name="bvn" placeholder="2456789898" onChange={handleInputChange} />
        </Form.Item>
        ...
        <Form.Item label="Phone Number">
          <InputNumber type="number" value={state.phone} name="phone" placeholder="08103030067" />
        </Form.Item>
      </Form>
    </>
  );
