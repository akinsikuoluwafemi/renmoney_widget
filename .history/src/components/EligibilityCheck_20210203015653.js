    ...
    <>
      ...
      >
        ...
        <Form.Item label="Email">
          <Input type="email" value={email} name="email" placeholder="john@yahoo.com" onChange={handleInputChange}/>
        </Form.Item>
        <Form.Item label="State">
          <Input type="text" value={stateOfOrigin} name="stateOfOrigin" placeholder="lagos" onChange={handleInputChange} />
        </Form.Item>
        <Form.Item label="Lga">
