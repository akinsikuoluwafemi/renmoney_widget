...
export default function Widget() {
  ...
  const values = {firstName, lastName, middleName, email, stateOfOrigin, lga, income, bvn, dob,phone,gender,employmentStatus, residentialStatus, residentialAddress, dateMovedIn, martitalStatus, education, employer }
