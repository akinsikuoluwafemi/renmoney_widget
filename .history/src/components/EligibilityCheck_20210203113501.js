...
const FormSizeDemo = ({nextStep, handleInputChange, onChangeDate, handleGenderChange, handleEmploymentChange, handleIncomeChange,handleBvnChange, handlePhoneChange,v}) => {
