    ...
    <>
      ...
      >
        ...
        <Form.Item label="Monthly Income">
          <InputNumber type="number" value={income} name="income" placeholder="300000" onChange={handleIncomeChange} />
        </Form.Item>
        <Form.Item label="Bvn">
          <InputNumber type="number" value={state.bvn} name="bvn" placeholder="2456789898" onChange={handleBvnChange} />
        </Form.Item>
        ...
        <Form.Item label="Phone Number">
          <InputNumber type="number" value={state.phone} name="phone" placeholder="08103030067" onChange={handlePhoneChange} />
        </Form.Item>
      </Form>
    </>
  );
