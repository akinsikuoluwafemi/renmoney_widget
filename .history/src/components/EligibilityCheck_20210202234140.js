    ...
    <>
      ...
      >
        <Form.Item label="First Name">
          <Input type="text" value={firstName} name="firstName" placeholder="john" />
        </Form.Item>
        <Form.Item label="Middle Name">
          <Input type="text" value={middleName} name="middleName" placeholder="mike" />
        </Form.Item>
        ...
        <Form.Item label="State">
          <Input type="text" value={stateOfOrigin} name="stateOfOrigin" placeholder="texas" />
        </Form.Item>
        <Form.Item label="Lga">
          <Input type="text" value={lga} name="lga" placeholder="" />
        </Form.Item>
